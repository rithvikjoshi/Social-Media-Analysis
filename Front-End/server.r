...
shinyServer(function(input, output) {
  ...
  pos.words = scan('E:/Twitter Data Analysis Project/Hastag analysis/positive-words.txt', what='character', comment.char=';')
  neg.words = scan('E:/Twitter Data Analysis Project/Hastag analysis/negative-words.txt', what='character', comment.char=';')
